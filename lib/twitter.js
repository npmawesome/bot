 ...
 * @return {string} The OAuth signature for adding to the HTTP header (e.g. Authorization: OAuth <signature>)
 *
 */
 ...
 *
 */
Twitter.prototype.post = function post (message, callback) {
